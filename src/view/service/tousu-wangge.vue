  ...
  <div class="advise boxright">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="detail(scope.row,'详情')">
            详情
          </el-button>
...
export default {
  ...
  methods: {
    ...
    getrenyuan(){      
      ...
      request({
        url: "EComplaint/GetEmployeeList",
        method: "get",
        params: this.renyuan
      }).then(response => {
        if (response.Status == 1) {
    ...
    getList(){
      ...
      request({
        url: "EComplaint/GetComplaintList",
        method: "get",
